...
describe('Variables in Typscript', () => {
    it('any tying', () => {
        let x;
...
it('use the as template strings', () => {
...
describe('enums and union constants', () => {
    describe('enums', () => {
        ...
        describe('type assertations', () => {

            interface ValueAndString
